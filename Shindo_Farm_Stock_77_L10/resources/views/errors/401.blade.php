...
<head>
    ...
    <title>Kamu Belum Masuk - SHINDO FARM 77</title>
...
<body>
    <main class="card" role="main">
        ...
        <div class="e-code-wrap"><span class="e-code">Error 401</span></div>
        <h1>Kamu belum masuk</h1>
        <p class="desc">Halaman ini hanya bisa diakses setelah login.<br>Silakan masuk dengan akunmu terlebih dahulu.</p>
