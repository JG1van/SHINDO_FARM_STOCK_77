...
<head>
    ...
    <title>Sedang Dalam Pemeliharaan - SHINDO FARM 77</title>
...
<body>
    <main class="card" role="main">
        ...
        <div class="e-code-wrap"><span class="e-code">Error 503</span></div>
        <h1>Sedang dalam pemeliharaan</h1>
        <p class="desc">Sistem sedang kami perbarui untuk pengalaman yang lebih baik.<br>Mohon tunggu sebentar dan coba kembali.</p>
