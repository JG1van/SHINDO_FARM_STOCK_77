...
<head>
    ...
    <title>Halaman Tidak Berlaku Lagi - SHINDO FARM 77</title>
...
<body>
    <main class="card" role="main">
        ...
        <div class="e-code-wrap"><span class="e-code">Error 419</span></div>
        <h1>Halaman tidak berlaku lagi</h1>
        <p class="desc">Halaman kedaluwarsa akibat tidak ada aktivitas terlalu lama,<br>atau terjadi pergantian akun di browser yang sama.</p>
