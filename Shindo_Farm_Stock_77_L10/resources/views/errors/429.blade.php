...
<head>
    ...
    <title>Terlalu Banyak Percobaan - SHINDO FARM 77</title>
...
<body>
    <main class="card" role="main">
        ...
        <div class="e-code-wrap"><span class="e-code">Error 429</span></div>
        <h1>Terlalu banyak percobaan</h1>
        <p class="desc">Kamu terlalu sering mencoba dalam waktu singkat.<br>Mohon tunggu sebentar sebelum mencoba lagi.</p>
